...
class CppiaAssetLibrary extends AssetLibrary {
...
class CppiaAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		path.set ("assets/graphics/1.5x/sprite-1-0.png", "assets/graphics/1.5x/sprite-1-0.png");
		...
		path.set ("assets/graphics/2x/sprite-1-0.png", "assets/graphics/2x/sprite-1-0.png");
		type.set ("assets/graphics/2x/sprite-1-0.png", AssetType.IMAGE);
		path.set ("assets/graphics/4x/sprite-1-0.png", "assets/graphics/4x/sprite-1-0.png");
		...
		path.set ("assets/data/MyDataStructures.txt", "assets/data/MyDataStructures.txt");
		type.set ("assets/data/MyDataStructures.txt", AssetType.TEXT);
		...
		path.set ("assets/data/[ext] extras manager/templates/New Image.png", "assets/data/[ext] extras manager/templates/New Image.png");
		type.set ("assets/data/[ext] extras manager/templates/New Image.png", AssetType.IMAGE);
		path.set ("assets/data/[ext] extras manager/templates/New Text.txt", "assets/data/[ext] extras manager/templates/New Text.txt");
		type.set ("assets/data/[ext] extras manager/templates/New Text.txt", AssetType.TEXT);
		path.set ("assets/data/[ext] scene link/pages/0.xml", "assets/data/[ext] scene link/pages/0.xml");
		type.set ("assets/data/[ext] scene link/pages/0.xml", AssetType.TEXT);
		...
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/data/MyDataStructures.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		...
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/data/[ext] extras manager/templates/New Image.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/data/[ext] extras manager/templates/New Text.txt";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
		id = "assets/data/[ext] scene link/pages/0.xml";
		path.set (id, id);
		type.set (id, AssetType.TEXT);
